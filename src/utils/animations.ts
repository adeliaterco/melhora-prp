...
export const getHotmartUrl = (plan?: number): string => {
  ...
  const baseUrls: { [key: number]: string } = {
    14: 'https://pay.hotmart.com/F100142422S?off=qqcmu6vg&checkoutMode=10', // ← TROCAR LINK DO PLANO $14
    27: 'https://pay.hotmart.com/F100142422S?off=qqcmu6vg&checkoutMode=10'  // ← TROCAR LINK DO PLANO $27
  };
